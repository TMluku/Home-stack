...
- Text price extraction should skip unit prices, tax-excluded prices, reference/list prices such as `MSRP` or `RRP`, unavailable or sold-out prices, and pack component prices such as `80円 x 12本` when a total price is present.
