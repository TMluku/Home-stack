...
- Structured reward fields that contain date-like strings such as `valid through 2026-06-20` or `expires 2026-06-20` should become condition evidence, not `2026円` point/coupon deductions.
