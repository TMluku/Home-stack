...
- Text price extraction should skip unit prices, tax-excluded prices, reference/list prices such as `MSRP` or `RRP`, installment/monthly financing amounts such as `500 JPY per mo.`, unavailable or sold-out prices, sample/trial/tester prices, and pack component prices such as `80円 x 12本` when a total price is present.
