...
export function calculateDaysLeft(item, household) {
...
export function getUrgentInventory(state) {
...
export function offerMatchesHousehold(offer, state) {
...
export function getRecommendedOffers(state, offers) {
...
export function getBestOfferForCategory(category, state, offers) {
  return offers
...
export function canAutoReserve(item, offer, autopilot) {
...
export function buildReplenishmentQueue(state, offers) {
