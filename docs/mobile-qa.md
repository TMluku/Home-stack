...
- `mobile-price-condition-proof.json`: captured URL, expected published Pages URL, Browser E2E workflow link, viewport, overflow metrics, hero visual/QR metrics, QA checklist count, condition badges, condition quick-read rows, condition guardrails, condition action note, deduction confirmation checklist, condition-summary rows, price-breakdown rows, price-verification lanes, condition fallback recompare price, seller link, and the assertions covered by the automated pass
