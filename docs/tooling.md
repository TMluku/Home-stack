...
| `pnpm run test:e2e` | Smoke-test the published GitHub Pages URL and visual asset response, including the expected PNG dimensions. |
...
| `pnpm run check:real-device-qa` | Confirm `docs/mobile-qa.md` contains a real-phone GitHub Pages `Pass` row with published URL and evidence notes. |
